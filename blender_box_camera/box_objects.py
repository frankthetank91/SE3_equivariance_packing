...
object_paths = [
    os.path.join("power_drill/model.urdf"), # obj_0
    os.path.join("scissors/model.urdf"), # obj_1
    os.path.join("shampoo/model.urdf"), # obj_2
    os.path.join("small_clamp/model.urdf"), # obj_3
]
...
for i in range(len(object_paths)):
    ...
    obj_id = p.loadURDF(
        ...
        basePosition=[random.uniform(box_center[0]-dimensions[0]/2, box_center[0]+dimensions[0]/2), random.uniform(box_center[1]-dimensions[1]/2, box_center[1]+dimensions[1]/2), random.uniform(dimensions[2], dimensions[2]+0.3)],
